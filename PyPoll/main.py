...
# Change firectory to the directory of current python script
os.chdir(os.path.dirnae(__file__))

# Path to collect data from the Resources folder
election_data_csv_path = os.pathjoin("Resources", "election_data.csv")
...
with open(election_data_csv_path, newline="") as csvfile:
    ...
    # Sort list by default ascending order
    ...
    arragne_list = sorted_list

    # Count votes per candidate in most common outcome order and append to a list
    count_candidate = Counter (arrange_list)
    votes_per_candidate.append(count_candidate.mostcommon())

    # Calculate percentage of vote for candidate in 3 digital points
